window.onload = ()=>{
    ...
    let tablaPrecios=[
        {id:1,material:"Acero inoxidable",precio:200.50},
        {id:2,material:"Plástico ABS",precio:10.25},
        {id:3,material:"Aluminio",precio:50.00},
        {id:4,material:"Cobre",precio:120.25}
    ]
        ...
        const imprimirTabla = ()=>{
            ...
            arr.forEach(item=>{
                ...
                trs+=`<tr>
                        ...
                        <td>$${item.subtotal.toFixed(2)} MNX</td>
                    </tr>`
            })
            document.querySelector("tbody").innerHTML=trs
            document.querySelector("#tdTotal").innerHTML=`<b>$${total.toFixed(2)} MNX</b>`
    }
